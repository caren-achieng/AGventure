                    ...
                    <div class="col-3" >
                        <div class="card">
                            ...
                            <div class="card-body">
                              ...
                              <p class="card-text mb-0"> Product Price: {{ $post->price }}</p>
                              <p class="card-text mb-0">Available stock: {{ $post->stock }}</p>
                              <p class="card-text mb-0">Item Description: {{ $post->description }}</p>
